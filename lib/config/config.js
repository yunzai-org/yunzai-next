...
import { readdirSync, mkdirSync, existsSync, copyFileSync, readFileSync } from 'node:fs';
...
class ProcessConfig {
    ...
    */
    getGroup(groupId = '') {
        ...
        if (config[groupId])
            return { ...config.default, ...config[groupId] };
...
var cfg = new ConfigController();

export { ProcessConfig, cfg as default };
